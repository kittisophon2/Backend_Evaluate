export const list = (req,res) => res.json({}); export const create = (req,res) => res.json({}); export const get = (req,res) => res.json({}); export const update = (req,res) => res.json({}); export const remove = (req,res) => res.json({});import prisma from '../../prisma/client.js';
